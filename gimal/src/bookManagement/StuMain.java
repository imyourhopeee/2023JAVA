...
public class StuMain extends JFrame{
	private static final long serialVersionUID= 1L; //에러 수정
	...
	public StuMain() {
		...
		label_00.setBounds(12,60,57,15);
		label_00.setFont(new Font("맑은 고딕", Font.BOLD,15));
		label_00.setHorizontalAlignment(JLabel.CENTER);
		contentPane.add(label_00);
		
		JLabel label_01=new JLabel("이름");
		label_01.setBounds(12,30,100,15);
		...
		textField_01.setBounds(81,50,243,21);
